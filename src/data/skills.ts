...
export const CLASS_SKILLS = {
  ...
  ranger: {
    ...
    r: {
      ...
      slot: "r",
      name: "레인 에로우",
      text: "넓은 지정 지점에 화살비를 내려 뭉친 적을 3.2초 동안 지속 타격합니다.",
  ...
  engineer: {
    ...
    e: {
      ...
      slot: "e",
      name: "메카 탑승",
      text: "8.5초 동안 메카에 탑승해 방어력과 방어막을 얻고 빠른 양손 레이저 기본공격을 사용합니다.",
    ...
    r: {
      ...
      slot: "r",
      name: "감전 지뢰",
      text: "밟으면 넓게 폭발하는 전기 지뢰를 설치해 큰 피해와 둔화를 줍니다.",
    ...
    f: {
      ...
      slot: "f",
      name: "호위 드론",
      text: "14초 동안 플레이어를 따라다니며 주변 적을 빠르게 지원 사격하는 드론을 호출합니다.",
