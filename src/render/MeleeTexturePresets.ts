export function drawSwordCut(ctx: CanvasRenderingContext2D): void {
...
export function drawCleave(ctx: CanvasRenderingContext2D): void {
...
export function drawWarriorCone(ctx: CanvasRenderingContext2D): void {
  const originX = 14;
  const originY = 59;
...
export function drawWarriorCleaveCone(ctx: CanvasRenderingContext2D): void {
  const originX = 15;
  const originY = 79;
...
export function drawWarriorBlade(ctx: CanvasRenderingContext2D): void {
...
export function drawWarriorSpinBlade(ctx: CanvasRenderingContext2D): void {
  ctx.save();
  ctx.translate(74, 74);
  for (let i = 0; i < 4; i += 1) {
...
export function drawChargeLane(ctx: CanvasRenderingContext2D): void {
...
export function drawSpin(ctx: CanvasRenderingContext2D): void {
...
export function drawImpactStar(ctx: CanvasRenderingContext2D): void {
  ...
  for (let i = 0; i < 8; i += 1) {
    ...
    ctx.beginPath();
    ctx.moveTo(36 + Math.cos(angle) * 9, 36 + Math.sin(angle) * 9);
    ctx.lineTo(36 + Math.cos(angle) * 30, 36 + Math.sin(angle) * 30);
    ctx.stroke();
  }
  ctx.fillStyle = "#ffffff";
...
export function drawShieldWedge(ctx: CanvasRenderingContext2D): void {
...
export function drawTauntBurst(ctx: CanvasRenderingContext2D): void {
  ctx.strokeStyle = "rgba(255,255,255,0.9)";
  ctx.lineWidth = 6;
  ctx.lineCap = "square";
  for (let i = 0; i < 8; i += 1) {
    const angle = (Math.PI * 2 * i) / 8;
    ctx.beginPath();
    ctx.moveTo(48 + Math.cos(angle) * 19, 48 + Math.sin(angle) * 19);
    ctx.lineTo(48 + Math.cos(angle) * 43, 48 + Math.sin(angle) * 43);
    ctx.stroke();
  }
