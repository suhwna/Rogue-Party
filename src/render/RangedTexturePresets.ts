...
export function drawArrowStreak(ctx: CanvasRenderingContext2D): void {
...
export function drawArrowFan(ctx: CanvasRenderingContext2D): void {
...
export function drawArrowRain(ctx: CanvasRenderingContext2D): void {
  ctx.strokeStyle = "rgba(255,255,255,0.92)";
  ctx.lineWidth = 4;
  ctx.lineCap = "square";
  for (let i = 0; i < 5; i += 1) {
...
export function drawPierceLance(ctx: CanvasRenderingContext2D): void {
