import { classPalette } from "./TexturePalettes";
import { linePx, outline, px } from "./PixelDrawing";

export function drawActorSheetFrame(
  ctx: CanvasRenderingContext2D,
  classId: string,
  frame: number,
  state: string,
): void {
  const [main, dark, light] = classPalette(classId);
